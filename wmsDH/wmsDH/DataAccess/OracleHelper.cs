...
namespace wmsDH.DataAccess
{
    ...
    public sealed class OracleHelper
    {
        ...
        /// 本地数据库连接字符串
        /// </summary>
        public static string LocalConnectionString = ConfigurationManager.ConnectionStrings["conectionStr"].ConnectionString;
       // public static string LocalConnectionString ;
        ...
        public static XmlDocument dataAccessXml;
        #endregion
        ...
        static OracleHelper()
        {
            dataAccessXml = new XmlDocument();

            dataAccessXml.Load("DataAccess\\dataAccess.xml");
        ...
        //{
        //    FileStream readFileStream = new FileStream(Application.ResourceAssembly.StartupPath + "\\sha",FileMode.Open, FileAccess.Read);
        ...
        public static DataTable CheckBoxTable(string sql, OracleParameter[] param)
        {
            ...
            using (OracleConnection connection = new OracleConnection(LocalConnectionString))
            {
                ...
                if (param != null)
                {
                    AttachParameters(command, param);
                }
                connection.Open();
...
#region ExecuteNonQuery
        ...
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="oracleParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        ...
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="oracleParameter">A OracleParamter used to execute the command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
...
#region ExecuteReader
        ...
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">An array of OracleParamter used to execute the command</param>
        /// <returns>A OracleDataReader containing the resultset generated by the command</returns>
        ...
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="commandParameter">A OracleParamter used to execute the command</param>
        /// <returns>A OracleDataReader containing the resultset generated by the command</returns>
